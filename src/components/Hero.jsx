export default function Hero({ onFindMentor, onBecomeMentor }) {
  return (
    <section className="bg-slate-950 py-12 md:py-24 px-4">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        {/* Left: Headline + CTAs */}
        <div>
          <h1 className="text-3xl md:text-5xl font-extrabold text-slate-100 mb-4 leading-tight tracking-tight">
            Get mentored by those doing it.
          </h1>

          <p className="text-base md:text-lg text-slate-300/85 mb-6 max-w-xl">
        ...
        <div className="w-full flex justify-center md:justify-end">
          <div className="w-full max-w-md bg-linear-to-br from-slate-900 to-slate-800 rounded-2xl p-5 border border-slate-800 shadow-xl hover:shadow-2xl transition-transform transform hover:scale-[1.01]">
