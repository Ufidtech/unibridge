      ...
      <div className="bg-slate-900 rounded-lg w-11/12 max-w-xl p-6 border border-slate-800 shadow-2xl">
        <div className="flex items-start justify-between mb-4">
          <h3 className="text-lg font-bold text-slate-100">
            Why we recommended {mentor?.name}
          </h3>
          <button
            onClick={onClose}
        ...
        <div className="text-sm text-slate-300 space-y-3">
          ...
          <p className="text-slate-400 text-base">
            Overall Match Score:{" "}
            <span className="font-bold text-blue-400">{displayScore}</span>
          </p>
          ...
          <div className="mt-4">
            ...
            <ul className="list-disc list-inside text-slate-400 space-y-1">
              ...
              <li>
                Interest-&gt;skill match: {Math.round(interestMatch * 100)}%
              </li>
        ...
        <div className="mt-6 flex justify-end">
          <button
            onClick={onClose}
            className="px-5 py-2 bg-slate-800 hover:bg-slate-700 text-slate-200 font-semibold rounded-lg cursor-pointer transition"
          >
            Close
          </button>
        </div>
